      ...
      <section className="hidden lg:grid col-span-12 lg:col-span-7 grid-cols-2 grid-rows-2 gap-6 relative z-10">
        ...
        <div className="col-span-2 row-span-1 bg-[#dae2ff] rounded-xl p-8 flex flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-2xl font-black tracking-tight text-[#0040a1]">Precision Engine</h1>
            </div>
          ...
          <div className="relative z-10 flex items-center gap-4">
            ...
            <p className="text-sm font-medium text-[#3a485b]">Hơn 500+ Garage đang vận hành</p>
          </div>
        ...
        <div className="col-span-1 row-span-1 bg-[#f2f4f6] rounded-xl p-6 flex flex-col justify-between border-0">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500 font-medium">Hiệu suất vận hành</div>
          </div>
        </div>
        ...
        <div className="col-span-1 row-span-1 bg-[#d5e3fc] rounded-xl p-6 flex flex-col justify-between border-0">
          ...
          <div>
            ...
            <div className="text-sm text-[#3a485b] font-medium">Tốc độ xử lý dữ liệu</div>
          </div>
        </div>
      </section>
      ...
      <section className="col-span-12 lg:col-span-5 bg-white rounded-xl shadow-sm flex flex-col overflow-hidden relative z-10">
        <div className="flex-1 flex flex-col justify-center px-8 lg:px-16 py-12">
          <div className="mb-10 text-center lg:text-left">
            <h3 className="text-3xl font-bold text-gray-900 mb-2 tracking-tight">Chào mừng trở lại</h3>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-500 block" htmlFor="username">Email hoặc Tên đăng nhập</label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#0040a1] transition-colors">person</span>
                <input 
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                <label className="text-sm font-semibold text-gray-500 block" htmlFor="password">Mật khẩu</label>
                <a className="text-xs font-bold text-[#0040a1] hover:underline" href="#">Quên mật khẩu?</a>
              </div>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#0040a1] transition-colors">lock</span>
                <input 
                  ...
                  type="password"
                />
                <button className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-900" type="button">
            ...
            <div className="flex items-center gap-3">
              <input className="w-5 h-5 rounded border-gray-300 text-[#0040a1] focus:ring-[#0040a1]" id="remember" type="checkbox" />
              <label className="text-sm font-medium text-gray-500 select-none" htmlFor="remember">Ghi nhớ đăng nhập trên thiết bị này</label>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-500">Bạn gặp sự cố kỹ thuật? 
              <a className="font-bold text-[#0040a1] hover:underline ml-1" href="#">Liên hệ hỗ trợ</a>
            </p>
          </div>
        </div>
