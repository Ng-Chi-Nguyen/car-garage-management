...
function FinanceField({ label, icon, value, onChange, placeholder }) {
  return (
    <label className="space-y-2">
      ...
      <div className="flex items-center gap-3 rounded-xl bg-white px-4 py-3 transition ring-1 ring-slate-200 focus-within:ring-2 focus-within:ring-blue-600/30 focus-within:shadow-[0_0_12px_rgba(0,64,161,0.08)]">
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-end">
            <button
              type="button"
              className="inline-flex items-center justify-center gap-2 rounded-xl border-0 bg-slate-100 px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-200"
            >
              Hủy thao tác
            </button>
            <button
              type="button"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-[#0040a1] to-[#0056d2] px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90"
            >
              <span>💾</span>
              Lưu Phiếu thu
            </button>
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.9fr)]">
              ...
              <FinancePanel icon="🧾" title="Thông tin Phiếu thu" description="Nhập thông tin khách hàng và số tiền thanh toán thực tế.">
                ...
                <div className="mt-5 grid gap-4 md:grid-cols-3">
                  ...
                  <label className="space-y-2 md:col-span-2">
                    ...
                    <div className="flex items-center gap-3 rounded-xl bg-slate-50 px-4 py-4 transition ring-1 ring-slate-200 focus-within:ring-2 focus-within:ring-blue-600/30 focus-within:bg-white focus-within:shadow-[0_0_12px_rgba(0,64,161,0.08)]">
                ...
                <div className="mt-5">
                  <label className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl bg-slate-50 px-4 py-3 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 ring-1 ring-slate-200 focus:ring-2 focus:ring-blue-600/30 focus:bg-white"
                    />
                  </label>
                </div>
                ...
                <div className="mt-6 rounded-xl bg-amber-50 px-5 py-4">
                  ...
                  <button
                    type="button"
                    className="mt-4 inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-[#0040a1] to-[#0056d2] px-5 py-3 text-sm font-semibold text-white transition hover:opacity-90"
                  >
                    Xác nhận Thu tiền
                  </button>
                </div>
              ...
              >
                <div className="space-y-3">
                  {receivableCustomers.map((item) => (
                    <article
                      key={item.plate}
                      className="flex flex-col gap-4 rounded-xl bg-slate-50 px-5 py-4 transition hover:bg-slate-100 lg:flex-row lg:items-center lg:justify-between"
                    >
                      <div className="flex items-center gap-4">
                        <div className="rounded-xl bg-slate-200 px-4 py-3 text-sm font-semibold text-slate-800">
                          {item.plate.split('-')[0]}
                        </div>
                        <div>
            ...
            <div className="space-y-6">
              <section className="rounded-2xl bg-slate-900 p-6 text-white relative overflow-hidden">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                      <button
                        type="button"
                        className="inline-flex items-center justify-center rounded-xl bg-white px-4 py-3 text-sm font-semibold text-emerald-900 transition hover:bg-emerald-100 ring-1 ring-emerald-200"
                      >
                        Quay lại
                      </button>
                      <button
