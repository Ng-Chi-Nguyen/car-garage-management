  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard title="Tổng số khách hàng" value="1,250" trend="+5.2%" trendDirection="up" />
        <StatCard title="Khách hàng mới (Tháng)" value="45" trend="+12.5%" trendDirection="up" />
        <StatCard title="Khách hàng quay lại" value="68%" trend="-2.1%" trendDirection="down" />
      </div>
