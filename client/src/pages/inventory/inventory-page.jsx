    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex items-center gap-2 bg-surface-container-low p-1.5 rounded-xl">
          <button className="px-4 py-1.5 bg-surface-container-lowest shadow-sm rounded-lg text-xs font-bold text-primary">
            Tất cả
          </button>
          <button className="px-4 py-1.5 hover:bg-surface-container-high rounded-lg text-xs font-bold text-slate-500 transition-colors">
            Dầu nhớt
          </button>
          <button className="px-4 py-1.5 hover:bg-surface-container-high rounded-lg text-xs font-bold text-slate-500 transition-colors">
            Bugi
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="col-span-12 md:col-span-6 bg-surface-container-lowest p-6 rounded-3xl shadow-sm flex items-center justify-between gap-6">
          <div className="flex-1">
            <p className="text-slate-500 text-xs font-semibold mb-1 uppercase tracking-tight">
              Giá trị kho hiện tại
            </p>
            <h3 className="text-3xl font-bold text-on-surface">
              4.820.500.000{" "}
              <span className="text-sm font-medium text-slate-400">VNĐ</span>
            </h3>
      ...
      >
        <DataTable headers={tableHeaders}>
          <tr className="hover:bg-surface-container-low transition-colors group">
            ...
            <td className="px-6 py-4">
              <p className="text-sm font-semibold text-on-surface">
                Dầu nhớt Castrol Power1 10W-40
              </p>
              <p className="text-[10px] text-slate-400 font-medium">
                Nhóm: Dầu nhớt & Phụ gia
              </p>
            </td>
          ...
          <tr className="hover:bg-surface-container-low transition-colors group">
            ...
            <td className="px-6 py-4 text-right font-bold text-sm text-error">
              5
            </td>
            <td className="px-6 py-4 text-right text-sm text-slate-500">
              225,000
