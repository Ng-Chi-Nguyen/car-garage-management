    ...
    <header className="h-[72px] bg-surface-container-lowest/85 backdrop-blur-[12px] flex items-center justify-between px-8 sticky top-0 z-10 border-b border-outline-variant/10">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          ...
          <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary font-bold text-[0.875rem] group-hover:bg-primary group-hover:text-white transition-all shadow-sm group-hover:shadow-primary/20">
            A
          </div>
        </div>
      </div>
