...
| `/repair-orders/new` | `client/src/pages/repair/RepairOrder.jsx` | Placeholder | Unknown | Sibling: `client/src/pages/repair/repair-order-page.jsx` | TBD | `http://localhost:5173/repair-orders/new` | "Lập phiếu sửa chữa" | Block if no safe source |
>>>>>>> hive/ui-tailwind-recovery/05-reconstruct-settlementprint-and-intakemodalpage-from-nearby-intakefinance-sources
